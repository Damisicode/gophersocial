...
import (
	...
	"github.com/Damisicode/social/docs"
...
func (app *application) mount() http.Handler {
	...
	r.Use(app.RateLimiterMiddlerware)
	...
	r.Route("/v1", func(r chi.Router) {
		// Operations
		r.Get("/health", app.healthCheckHandler)         // With(app.BasicAuthMiddleware()).
		r.Get("/debug/vars", expvar.Handler().ServeHTTP) // With(app.BasicAuthMiddleware()).
